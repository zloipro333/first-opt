<template>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="background: rgba(255, 255, 255, 0); display: block; shape-rendering: auto; animation-play-state: running; animation-delay: 0s;" width="200px" height="200px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
    <g transform="translate(80,50)" style="animation-play-state: running; animation-delay: 0s;">
    <g transform="rotate(0)" style="animation-play-state: running; animation-delay: 0s;">
    <circle cx="0" cy="0" r="6" fill="rgb(0, 0, 0)" fill-opacity="1" style="animation-play-state: running; animation-delay: 0s;">
    ...
    <circle cx="0" cy="0" r="6" fill="rgb(0, 0, 0)" fill-opacity="0.875" style="animation-play-state: running; animation-delay: 0s;">
    ...
    <circle cx="0" cy="0" r="6" fill="rgb(0, 0, 0)" fill-opacity="0.75" style="animation-play-state: running; animation-delay: 0s;">
    ...
    <circle cx="0" cy="0" r="6" fill="rgb(0, 0, 0)" fill-opacity="0.625" style="animation-play-state: running; animation-delay: 0s;">
    ...
    <circle cx="0" cy="0" r="6" fill="rgb(0, 0, 0)" fill-opacity="0.5" style="animation-play-state: running; animation-delay: 0s;">
    ...
    <circle cx="0" cy="0" r="6" fill="rgb(0, 0, 0)" fill-opacity="0.375" style="animation-play-state: running; animation-delay: 0s;">
    ...
    <circle cx="0" cy="0" r="6" fill="rgb(0, 0, 0)" fill-opacity="0.25" style="animation-play-state: running; animation-delay: 0s;">
    ...
    <circle cx="0" cy="0" r="6" fill="rgb(0, 0, 0)" fill-opacity="0.125" style="animation-play-state: running; animation-delay: 0s;">
